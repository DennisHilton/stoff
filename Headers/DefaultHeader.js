...
import FacilityEnquiry from './components/facility-enquiry';

export default function DefaultHeader ({ headerImage, maximized, setCustomTheme, setCustomLayoutType, setGlobalModal, setLoading, setMaximize }) {
  ...
  function closeAdditionalInfoFunc() {
    ...
    document.getElementById("defaultNavBar").style.paddingTop = "56px";
  }
  ...
  return (
    <>
      <header
        className="defaultHeader1 w-full"
        style={{
          position: "fixed",
          right: 0,
          left: 0,
      ...
      >
          ...
          <div className="">
            ...
            >
              <p style={{ fontSize: "14px", marginLeft: "16px" }}>
                Powered By : <b>X100 PLUS</b> &nbsp;&nbsp;|&nbsp;&nbsp; Address
                : <b>Lartebiokorshie; Accra, Ghana</b> &nbsp;&nbsp;|&nbsp;&nbsp;
                Email : <b>info@unionsg.com</b>
              </p>
            </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      >
                        {" "}
                        <b>X100 PLUS - Core Banking System</b>
                      </p>
                    </td>
                  </tr>
                </tbody>
        ...
        >
          <div className="">
            <div
              className="float-left testME head1"
              style={{
                marginTop: "-13px",
                overflowX: "scroll",
                whiteSpace: "nowrap",
            ...
            <div
              className="float-right pull-right flex-end head2"
              style={{
                marginTop: "-16px",
                alignItems: "center",
                textAlign: "right",
            ...
            >
              ...
              >
                <Select
                  ...
                  } transition ease-in-out duration-100 transform translate-x-0`}
                  onKeyDown={(e) => {
                    if (e.key === "Enter") {
              ...
              >
                ...
                >
                  ...
                  <Menu.Item
                    ...
                    onClick={() =>
                      setCustomTheme(
                        '{"theme": {"headerImage":"headerBGBlack.jpg", "backgroundImage":"bgBlack.jpg", "navBarColor":"#ececec", "breadcrumbBGColor": "#181816", "textColor":"white", "buttonBGColor": "#4d4d4d", "buttonTextColor": "white", "cardBGColor":"", "fontFamily":null}}'
                      )
                    }
                    icon={
                      <MDBIcon
