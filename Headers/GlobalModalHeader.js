...
export default function GlobalModalHeader ({ headerImage, breadCrumbDetails, modalSize, fullScreen, setModalSize, setFullscreen }) {
  ...
  function modalSizeMDFunc() {
    setModalSize("md");
    setFullscreen(false);
  }

  function modalSizeLGFunc() {
    setModalSize("lg");
    setFullscreen(false);
  }

  function modalSizeXLFunc() {
    setModalSize("xl");
    setFullscreen(false);
  }
  ...
  function closeModal(formName) {
    ...
    swal({
      title: "Are you sure?",
      text: "You're about to close the '" + formName + "' form",
      icon: "warning",
    ...
    <>
      ...
      >
        ...
        >
          <div className="">
            <div
              className="float-left testME gmhL"
              style={{
                marginTop: "-13px",
                width: "70%",
                overflowX: "scroll",
              ...
              >
                ...
                <Menu.Dropdown>
                  ...
                  <Menu.Item
                    ...
                    onClick={function (e) {
                      e.preventDefault();
                      setCustomerSearchNumber(!showCustomerSearchNumber);
                    }}
                    icon={
                      <MDBIcon
                        style={{ fontSize: "14px" }}
            ...
            <div
              className="float-right pull-right flex-end gmhR"
              style={{
                marginTop: "-16px",
                width: "30%",
                textAlign: "right",
            ...
            >
              ...
              >
                <MDBIcon id="minimizeModal" fas icon="minus" />
              </a>
              ...
              {(() => {
                ...
                } else if (modalSize === "xxl") {
                  return (
                    <>
                      <a
                        className="cursor-pointer"
                        onClick={() => removeFromFullScreen()}
                        style={{
                          textDecoration: "none",
                          marginLeft: "13px",
                          color: "grey",
                      ...
                      >
                        <MDBIcon id="maximizeModal" fas icon="minus-square" />
                      </a>
                    </>
                  );
                }
              ...
              {(() => {
                if (modalSize === "xxl" || fullScreen === true) {
                  return (
                    <a
                      className="cursor-pointer"
                      onClick={() => removeFromFullScreen()}
