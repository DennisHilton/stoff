...
export default function ModernHeader ({ headerImage, maximized, setTheme, setCustomTheme, setCustomLayoutType, setGlobalModal, setLoading, setMaximize }) {
  ...
  function closeAdditionalInfoFunc() {
    ...
    document.getElementById("stylishNavBar").style.paddingTop = "56px";
  }
          ...
          <div className="">
            ...
            >
              <p
                ...
                className="topLeftAddInfoModern"
              >
